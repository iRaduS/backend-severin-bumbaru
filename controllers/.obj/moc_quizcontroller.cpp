...
QT_MOC_LITERAL(3, 21, 8), // "group_id"
QT_MOC_LITERAL(4, 30, 2), // "id"
QT_MOC_LITERAL(5, 33, 6), // "remove"
QT_MOC_LITERAL(6, 40, 6) // "create"

    },
    "QuizController\0show\0\0group_id\0id\0"
    "remove\0create"
};
...
void QuizController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->show((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
        case 1: _t->remove((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
        case 2: _t->create((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}
